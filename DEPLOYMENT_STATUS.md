...
> **Purpose:** Hand-off notes for continuing the AWS deployment from any machine (Cursor, Likith Code, etc.)
...
- **LLM:** AWS Bedrock — `us.anthropic.Likith-haiku-4-5-20251001-v1:0` (cross-region inference profile)
...
| Bedrock model | `us.anthropic.Likith-haiku-4-5-20251001-v1:0` (confirmed ACTIVE) |
